...
function InsertSearchEntries(entry, insertcallback)
{
	var part;
	...
	var insert = db.insert(entry, function(err, newdoc) {
...
if (process.platform == 'darwin') {
	...
	require('./linux/ApplicationXdg').initialize(InsertSearchEntries);
}
else {
